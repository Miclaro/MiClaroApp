...
public class HomePage extends BasePage {
    ...
    public AndroidElement btnCerrarPopUpClaroClub;
    ...
    @AndroidFindBy(xpath="//android.view.View[@content-desc='tienda.claro.com']")
    public AndroidElement lblClaroTienda;

    @AndroidFindBy(xpath = "//android.view.View[@text='uF0C9']")
    public AndroidElement btnMenuClaroTienda;


    @AndroidFindBy(xpath = "//android.view.View[@text='Celulares']")
    public AndroidElement lblOpcionCelulares;
    ...
    public void setLinea(String linea){
        testUtils.getElement(btnPosicion1Parrilla1);
