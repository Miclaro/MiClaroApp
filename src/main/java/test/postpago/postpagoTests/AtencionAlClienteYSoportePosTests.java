...
public class AtencionAlClienteYSoportePosTests extends BaseTest {
    ...
    @Parameters({"lineaPostpago"})
    public void pos014_gestionaTuEquipo(String lineaPostpago)   {
    ...
    @Parameters({"lineaPostpago"})
    public void pos015_AdquirirProductos(String lineaPostpago) {
    ...
    @Parameters({"lineaPostpago"})
    public void pos016_ResuelvefallasServicios(String lineaPostpago){
    ...
    @Parameters({"lineaPostpago"})
    public void pos017_CentrosAtencionVentas(String lineaPostpago){
